      ...
      <section className='py-12 p-5'>
        ...
        <div className='flex flex-col items-center'>
          ...
          <div className='w-full lg:w-6/12 md:w-full p-5 border-2 rounded mb-4'>
            ...
            <p>In the first case, when data is fetched from any place, it is empty. When any data is found, we set the data in react to setProducts or any other name. When the state of the react state changes, it renders it in the browser for which we have to use data or any state with useState. </p>
          </div>
          <div className='w-full lg:w-6/12 md:w-full p-5 border-2 rounded mb-4'>
            ...
            <p>using array filter method you can search product by name. suppose you have products array of object. here you can use products.filter (product => product.name === 'macbook' ) then print. Simply. you can search products by name using filter array method. </p>
          </div>
